...
int BuddyJournal::prepare_entry(bufferlist* tbl) {
  dout(10) << "prepare_entry " << tls << dendl;
  ...
  // EUNJI
  // 여기서 transaction 을 encoding 하는게 아니고.. 
  // logging 된거를 encoding 해야함.. 
  // 여기에서 data_len 하고 data_align 에 의해서 pad 붙이는거는. 파악이 필요함. 
#if 0
